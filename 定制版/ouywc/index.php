...
<head>
    ...
    <meta itemprop="name" content="吃掉企鹅" />
...
<body onLoad="init()" oncontextmenu=self.event.returnValue=false>
    <div id="GameScoreLayer" class="BBOX SHADE bgc1" style="display:none;">
        <div style="padding:5%;margin-top: 200px;background-color: rgba(125, 181, 216, 0.3);">
                ...
                <button type="button" class="btn btn-secondary btn-lg" onclick="window.location.href='https://github.com/shundebo/music'" data-i18n="repo">REPO-I18N</button>
            </div>
    </div>
    </div>
            ...
            <div class="container">
                ...
                <div id="setting" class="container" style="display: none;">
                    <div class="container mb-3 btn-group">
                        ...
                        <input type="file" id="click-before-image" accept="https://s2.loli.net/2023/04/09/5kmHJPtdxEZAYyK.png" class="d-none" onchange="saveClickBeforeImage()">
                        ...
                        <input type="file" id="click-after-image" accept="https://s2.loli.net/2023/04/09/5HsD1BAMkISn3Ov.png" style="display: none;" onchange="saveClickAfterImage()">
